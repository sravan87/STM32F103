...
#define RCC_CFGR_HPRE_BIT		4	/* AHB prescaler	      */
#define RCC_CFGR_PPRE1_BIT	10	/* APB Low speed presc (APB1) */
#define RCC_CFGR_PPRE2_BIT	13	/* APB high-speed presc (APB2)*/
